...
const hasMedicalHistory = computed(() => {
    if (!props.visit.patient) return false;
    return props.visit.patient.drug_allergy || 
           props.visit.patient.underlying_disease || 
           props.visit.patient.surgery_history || 
           props.visit.patient.accident_history;
});
</script>
