...
<template>
    <Head title="เพิ่มบริการใหม่" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">เพิ่มบริการใหม่</h2>
        </template>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="block mt-4">
                                <label class="flex items-center">
                                    ...
                                    <span class="ms-2 text-sm text-gray-600">เปิดใช้งานทันที</span>
                                </label>
                            </div>
